...
const STRINGS = Object.freeze({
  en: Object.freeze({
    ...
    "field.translation.disableCjkFilter.description": "When turned on, only translates ingame text in Chinese, Japanese, or Korean.",
    "field.translation.disableCjkFilter.tooltip": "Translate only in-game text that contains Chinese, Japanese, or Korean characters.",
  ...
  ko: Object.freeze({
    ...
    "field.translation.disableCjkFilter.description": "켜면 중국어, 일본어, 한국어가 포함된 게임 내 텍스트만 번역합니다.",
    "field.translation.disableCjkFilter.tooltip": "중국어, 일본어, 한국어 문자가 포함된 게임 텍스트만 번역합니다.",
